...
REGIME_SCORE_RETENTION_DAYS = int(os.getenv("REGIME_SCORE_RETENTION_DAYS", "14"))
REGIME_GATE_RETENTION_DAYS = int(os.getenv("REGIME_GATE_RETENTION_DAYS", "30"))
...
DUAL_ZONE_V3_EMA_TIMEFRAME = "15m"
...
DUAL_ZONE_V3_B_ENTRY_DISTANCE_PCT = float(os.getenv("DUAL_ZONE_V3_B_ENTRY_DISTANCE_PCT", "0.25"))
...
# Locked defaults: specs/resource-footprint-retention-v1.md section 4.
# 5m/15m must cover the maximum declared strategy lookback (20d) plus one
# day so no load_bars window is ever truncated by retention.
PRUNE_5M_DAYS = int(os.getenv("PRUNE_5M_DAYS", "21"))
PRUNE_15M_DAYS = int(os.getenv("PRUNE_15M_DAYS", "30"))
PRUNE_1H_DAYS = int(os.getenv("PRUNE_1H_DAYS", "30"))
PRUNE_4H_DAYS = int(os.getenv("PRUNE_4H_DAYS", "45"))
PRUNE_INTERVAL_DAYS = {
...
MARKET_WATCHLIST_RETENTION_DAYS = int(os.getenv("MARKET_WATCHLIST_RETENTION_DAYS", "90"))
MARKET_REGIME_RETENTION_DAYS = int(os.getenv("MARKET_REGIME_RETENTION_DAYS", "30"))
