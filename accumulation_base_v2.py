...
def load_config() -> AccV2Config:
    return AccV2Config(
        n=int(getattr(config, "ACC_V2_N", 16)),
        k=float(getattr(config, "ACC_V2_K", 3.0)),
        g=float(getattr(config, "ACC_V2_G", 0.35)),
        d_max=float(getattr(config, "ACC_V2_D_MAX", 0.75)),
        r_max=float(getattr(config, "ACC_V2_R_MAX", 3.0)),
        s_min=float(getattr(config, "ACC_V2_S_MIN", 0.40)),
        n_top=int(getattr(config, "ACC_V2_N_TOP", 5)),
    )
